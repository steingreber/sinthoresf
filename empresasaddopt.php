...
class cempresas_addopt extends cempresas {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					$row = array();
					$row["x_cod_empresa"] = $this->cod_empresa->DbValue;
					$row["x_nome_empresa"] = $this->nome_empresa->DbValue;
	...
	function LoadFormValues() {
		...
		if (!$this->nome_empresa->FldIsDetailKey) {
			$this->nome_empresa->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nome_empresa")));
		}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->nome_empresa->CurrentValue = ew_ConvertToUtf8($this->nome_empresa->FormValue);
	...
	function AddRow($rsold = NULL) {
		...
		// regiao
		$this->regiao->SetDbValueDef($rsnew, $this->regiao->CurrentValue, 0, FALSE);
...
// Page object
var empresas_addopt = new ew_Page("empresas_addopt");
empresas_addopt.PageID = "addopt"; // Page ID
var EW_PAGE_ID = empresas_addopt.PageID; // For backward compatibility

// Form object
var fempresasaddopt = new ew_Form("fempresasaddopt");
...
fempresasaddopt.ValidateRequired = true;
<?php } else { ?>
fempresasaddopt.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fempresasaddopt.Lists["x_regiao"] = {"LinkField":"x_id_regiao","Ajax":true,"AutoFill":false,"DisplayFields":["x_regiao","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_nome_empresa"><?php echo $empresas->nome_empresa->FldCaption() ?></label>
		<div class="col-sm-9">
<input type="text" data-field="x_nome_empresa" name="x_nome_empresa" id="x_nome_empresa" size="60" maxlength="50" placeholder="<?php echo ew_HtmlEncode($empresas->nome_empresa->PlaceHolder) ?>" value="<?php echo $empresas->nome_empresa->EditValue ?>"<?php echo $empresas->nome_empresa->EditAttributes() ?>>
	...
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_regiao"><?php echo $empresas->regiao->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-9">
