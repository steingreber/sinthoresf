...
class csocios_edit extends csocios {
	...
	function LoadFormValues() {
		...
		if (!$this->cod_socio->FldIsDetailKey)
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// dt_carteira
			$this->dt_carteira->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->dt_carteira->CurrentValue, 7), NULL, $this->dt_carteira->ReadOnly);

			// dt_entrou_empresa
			$this->dt_entrou_empresa->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->dt_entrou_empresa->CurrentValue, 7), NULL, $this->dt_entrou_empresa->ReadOnly);

			// dt_entrou_categoria
			$this->dt_entrou_categoria->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->dt_entrou_categoria->CurrentValue, 7), NULL, $this->dt_entrou_categoria->ReadOnly);

			// acompanhante
			$this->acompanhante->SetDbValueDef($rsnew, $this->acompanhante->CurrentValue, NULL, $this->acompanhante->ReadOnly);
...
fsociosedit.Lists["x_socio"] = {"LinkField":"x_cod_pessoa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nome","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fsociosedit.Lists["x_cod_empresa"] = {"LinkField":"x_cod_empresa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nome_empresa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if (!isset($socios_edit->Pager)) $socios_edit->Pager = new cPrevNextPager($socios_edit->StartRec, $socios_edit->DisplayRecs, $socios_edit->TotalRecs) ?>
<?php if ($socios_edit->Pager->RecordCount > 0) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($socios_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $socios_edit->PageUrl() ?>start=<?php echo $socios_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($socios_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $socios_edit->PageUrl() ?>start=<?php echo $socios_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $socios_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($socios_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $socios_edit->PageUrl() ?>start=<?php echo $socios_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($socios_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $socios_edit->PageUrl() ?>start=<?php echo $socios_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $socios_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
...
<?php if ($socios->cod_socio->Visible) { // cod_socio ?>
	<div id="r_cod_socio" class="form-group">
		<label id="elh_socios_cod_socio" class="col-sm-2 control-label ewLabel"><?php echo $socios->cod_socio->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $socios->cod_socio->CellAttributes() ?>>
...
<input type="hidden" data-field="x_cod_socio" name="x_cod_socio" id="x_cod_socio" value="<?php echo ew_HtmlEncode($socios->cod_socio->CurrentValue) ?>">
<?php echo $socios->cod_socio->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("fsociosedit", "x_dt_cadastro", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("fsociosedit", "x_validade", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("fsociosedit", "x_dt_carteira", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("fsociosedit", "x_dt_entrou_empresa", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("fsociosedit", "x_dt_entrou_categoria", "%d/%m/%Y");
</script>
<?php } ?>
</span>
