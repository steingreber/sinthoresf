...
class cfuncionarios_edit extends cfuncionarios {
	...
	function LoadFormValues() {
		...
		if (!$this->cod_func->FldIsDetailKey)
			$this->cod_func->setFormValue($objForm->GetValue("x_cod_func"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->cod_func->CurrentValue = $this->cod_func->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// cod_empresa
			$this->cod_empresa->SetDbValueDef($rsnew, $this->cod_empresa->CurrentValue, NULL, $this->cod_empresa->ReadOnly);

			// dt_entrou_empresa
			$this->dt_entrou_empresa->SetDbValueDef($rsnew, $this->dt_entrou_empresa->CurrentValue, NULL, $this->dt_entrou_empresa->ReadOnly);

			// dt_entrou_categoria
			$this->dt_entrou_categoria->SetDbValueDef($rsnew, $this->dt_entrou_categoria->CurrentValue, NULL, $this->dt_entrou_categoria->ReadOnly);
			...
			// dependentes
			$this->dependentes->SetDbValueDef($rsnew, $this->dependentes->CurrentValue, NULL, $this->dependentes->ReadOnly);

			// dtcad
			$this->dtcad->SetDbValueDef($rsnew, $this->dtcad->CurrentValue, NULL, $this->dtcad->ReadOnly);

			// dtcarteira
			$this->dtcarteira->SetDbValueDef($rsnew, $this->dtcarteira->CurrentValue, NULL, $this->dtcarteira->ReadOnly);

			// telefone
			$this->telefone->SetDbValueDef($rsnew, $this->telefone->CurrentValue, "", $this->telefone->ReadOnly);

			// acompanhante
			$this->acompanhante->SetDbValueDef($rsnew, $this->acompanhante->CurrentValue, "", $this->acompanhante->ReadOnly);
...
ffuncionariosedit.Lists["x_cod_empresa"] = {"LinkField":"x_cod_empresa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nome_empresa","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if (!isset($funcionarios_edit->Pager)) $funcionarios_edit->Pager = new cPrevNextPager($funcionarios_edit->StartRec, $funcionarios_edit->DisplayRecs, $funcionarios_edit->TotalRecs) ?>
<?php if ($funcionarios_edit->Pager->RecordCount > 0) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($funcionarios_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $funcionarios_edit->PageUrl() ?>start=<?php echo $funcionarios_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($funcionarios_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $funcionarios_edit->PageUrl() ?>start=<?php echo $funcionarios_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $funcionarios_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($funcionarios_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $funcionarios_edit->PageUrl() ?>start=<?php echo $funcionarios_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($funcionarios_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $funcionarios_edit->PageUrl() ?>start=<?php echo $funcionarios_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $funcionarios_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
...
<?php if ($funcionarios->cod_func->Visible) { // cod_func ?>
	<div id="r_cod_func" class="form-group">
		<label id="elh_funcionarios_cod_func" class="col-sm-2 control-label ewLabel"><?php echo $funcionarios->cod_func->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $funcionarios->cod_func->CellAttributes() ?>>
<span id="el_funcionarios_cod_func">
<span<?php echo $funcionarios->cod_func->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $funcionarios->cod_func->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_cod_func" name="x_cod_func" id="x_cod_func" value="<?php echo ew_HtmlEncode($funcionarios->cod_func->CurrentValue) ?>">
<?php echo $funcionarios->cod_func->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ffuncionariosedit", "x_datanasc", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ffuncionariosedit", "x_dt_entrou_empresa", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ffuncionariosedit", "x_dt_entrou_categoria", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ffuncionariosedit", "x_dtcad", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ffuncionariosedit", "x_dtcarteira", "%d/%m/%Y");
</script>
<?php } ?>
</span>
