...
$config_A04imagem_blobview = NULL; // Initialize page object first

class cconfig_A04imagem_blobview extends cconfig {
	...
	// Page object name
	var $PageObjName = 'config_A04imagem_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'config');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('config', 'x_A04imagem');
		...
		// SQL constructor in config class, configinfo.php
...
// Create page object
if (!isset($config_A04imagem_blobview)) $config_A04imagem_blobview = new cconfig_A04imagem_blobview();

// Page init
$config_A04imagem_blobview->Page_Init();

// Page main
$config_A04imagem_blobview->Page_Main();
?>
<?php
$config_A04imagem_blobview->Page_Terminate();
?>
