...
$funcionarios_foto_blobview = NULL; // Initialize page object first

class cfuncionarios_foto_blobview extends cfuncionarios {
	...
	// Page object name
	var $PageObjName = 'funcionarios_foto_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'funcionarios');
...
// Create page object
if (!isset($funcionarios_foto_blobview)) $funcionarios_foto_blobview = new cfuncionarios_foto_blobview();

// Page init
$funcionarios_foto_blobview->Page_Init();

// Page main
$funcionarios_foto_blobview->Page_Main();
?>
<?php
$funcionarios_foto_blobview->Page_Terminate();
?>
