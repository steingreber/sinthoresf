...
$rel_ficha_cadastro__foto_blobview = NULL; // Initialize page object first

class crel_ficha_cadastro__foto_blobview extends crel_ficha_cadastro_ {
	...
	// Page object name
	var $PageObjName = 'rel_ficha_cadastro__foto_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('funcionarios', 'x_foto');
...
// Create page object
if (!isset($rel_ficha_cadastro__foto_blobview)) $rel_ficha_cadastro__foto_blobview = new crel_ficha_cadastro__foto_blobview();

// Page init
$rel_ficha_cadastro__foto_blobview->Page_Init();

// Page main
$rel_ficha_cadastro__foto_blobview->Page_Main();
?>
<?php
$rel_ficha_cadastro__foto_blobview->Page_Terminate();
?>
