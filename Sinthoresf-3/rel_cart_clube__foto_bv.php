...
$rel_cart_clube__foto_blobview = NULL; // Initialize page object first

class crel_cart_clube__foto_blobview extends crel_cart_clube_ {
	...
	// Page object name
	var $PageObjName = 'rel_cart_clube__foto_blobview';
...
// Create page object
if (!isset($rel_cart_clube__foto_blobview)) $rel_cart_clube__foto_blobview = new crel_cart_clube__foto_blobview();

// Page init
$rel_cart_clube__foto_blobview->Page_Init();

// Page main
$rel_cart_clube__foto_blobview->Page_Main();
?>
<?php
$rel_cart_clube__foto_blobview->Page_Terminate();
?>
