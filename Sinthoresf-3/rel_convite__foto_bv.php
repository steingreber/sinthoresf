...
$rel_convite__foto_blobview = NULL; // Initialize page object first

class crel_convite__foto_blobview extends crel_convite_ {
	...
	// Page object name
	var $PageObjName = 'rel_convite__foto_blobview';
...
// Create page object
if (!isset($rel_convite__foto_blobview)) $rel_convite__foto_blobview = new crel_convite__foto_blobview();

// Page init
$rel_convite__foto_blobview->Page_Init();

// Page main
$rel_convite__foto_blobview->Page_Main();
?>
<?php
$rel_convite__foto_blobview->Page_Terminate();
?>
