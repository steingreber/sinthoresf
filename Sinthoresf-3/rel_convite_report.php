...
<!--
	<tr>
		<td class="ewGroupHeader"><?php echo $rel_convite_->cod_func->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $rel_convite_->nome->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $rel_convite_->cod_empresa->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $rel_convite_->foto->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $rel_convite_->acompanhante->FldCaption() ?></td>
	</tr>
-->
<?php
	}
...
<!--
	<tr>
		<td<?php echo $rel_convite_->cod_func->CellAttributes() ?>>
<span<?php echo $rel_convite_->cod_func->ViewAttributes() ?>>
<?php echo $rel_convite_->cod_func->ViewValue ?></span>
</td>
		<td<?php echo $rel_convite_->nome->CellAttributes() ?>>
<span<?php echo $rel_convite_->nome->ViewAttributes() ?>>
<?php echo $rel_convite_->nome->ViewValue ?></span>
</td>
		<td<?php echo $rel_convite_->cod_empresa->CellAttributes() ?>>
<span<?php echo $rel_convite_->cod_empresa->ViewAttributes() ?>>
<?php echo $rel_convite_->cod_empresa->ViewValue ?></span>
</td>
		<td<?php echo $rel_convite_->foto->CellAttributes() ?>>
<span>
<?php echo ew_GetFileViewTag($rel_convite_->foto, $rel_convite_->foto->ViewValue) ?>
</span>
</td>
		<td<?php echo $rel_convite_->acompanhante->CellAttributes() ?>>
<span<?php echo $rel_convite_->acompanhante->ViewAttributes() ?>>
<?php echo $rel_convite_->acompanhante->ViewValue ?></span>
</td>
	</tr>
-->
<table border="0" width="700" height="409" background="sistema/convite.jpg">
    <tr>
