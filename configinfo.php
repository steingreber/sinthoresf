...
class cconfig extends cTable {
	...
	function __construct() {
		...
		// A01URL
		$this->A01URL = new cField('config', 'config', 'x_A01URL', 'A01URL', '`A01URL`', '`A01URL`', 200, -1, FALSE, '`A01URL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// A04imagem
		$this->A04imagem = new cField('config', 'config', 'x_A04imagem', 'A04imagem', '`A04imagem`', '`A04imagem`', 200, -1, TRUE, '`A04imagem`', FALSE, FALSE, FALSE, 'IMAGE');
