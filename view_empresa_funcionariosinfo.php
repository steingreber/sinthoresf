...
$view_empresa_funcionarios = NULL;

//
// Table class for view_empresa_funcionarios
//
class cview_empresa_funcionarios extends cTable {
	var $cod_func;
	var $nome;
	var $cpf;
	var $cod_empresa;
	...
	function __construct() {
		...
		$this->TableVar = 'view_empresa_funcionarios';
		$this->TableName = 'view_empresa_funcionarios';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// cod_func
		$this->cod_func = new cField('view_empresa_funcionarios', 'view_empresa_funcionarios', 'x_cod_func', 'cod_func', '`cod_func`', '`cod_func`', 3, -1, FALSE, '`cod_func`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cod_func->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cod_func'] = &$this->cod_func;

		// nome
		$this->nome = new cField('view_empresa_funcionarios', 'view_empresa_funcionarios', 'x_nome', 'nome', '`nome`', '`nome`', 200, -1, FALSE, '`nome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nome'] = &$this->nome;

		// cpf
		$this->cpf = new cField('view_empresa_funcionarios', 'view_empresa_funcionarios', 'x_cpf', 'cpf', '`cpf`', '`cpf`', 200, -1, FALSE, '`cpf`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cpf'] = &$this->cpf;

		// cod_empresa
		$this->cod_empresa = new cField('view_empresa_funcionarios', 'view_empresa_funcionarios', 'x_cod_empresa', 'cod_empresa', '`cod_empresa`', '`cod_empresa`', 3, -1, FALSE, '`cod_empresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cod_empresa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cod_empresa'] = &$this->cod_empresa;

		// nome_empresa
		$this->nome_empresa = new cField('view_empresa_funcionarios', 'view_empresa_funcionarios', 'x_nome_empresa', 'nome_empresa', '`nome_empresa`', '`nome_empresa`', 200, -1, FALSE, '`nome_empresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nome_empresa'] = &$this->nome_empresa;

		// endereco
		$this->endereco = new cField('view_empresa_funcionarios', 'view_empresa_funcionarios', 'x_endereco', 'endereco', '`endereco`', '`endereco`', 200, -1, FALSE, '`endereco`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['endereco'] = &$this->endereco;

		// A10PALAVRAS
		$this->A10PALAVRAS = new cField('view_empresa_funcionarios', 'view_empresa_funcionarios', 'x_A10PALAVRAS', 'A10PALAVRAS', '`A10PALAVRAS`', '`A10PALAVRAS`', 201, -1, FALSE, '`A10PALAVRAS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['A10PALAVRAS'] = &$this->A10PALAVRAS;

		// ativo
		$this->ativo = new cField('view_empresa_funcionarios', 'view_empresa_funcionarios', 'x_ativo', 'ativo', '`ativo`', '`ativo`', 3, -1, FALSE, '`ativo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->ativo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ativo'] = &$this->ativo;

		// numero
		$this->numero = new cField('view_empresa_funcionarios', 'view_empresa_funcionarios', 'x_numero', 'numero', '`numero`', '`numero`', 3, -1, FALSE, '`numero`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`view_empresa_funcionarios`";
	}
	...
	// Update Table
	var $UpdateTable = "`view_empresa_funcionarios`";
	...
	function SqlKeyFilter() {
		return "`cod_func` = @cod_func@ AND `cod_empresa` = @cod_empresa@";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_empresa_funcionarioslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_empresa_funcionariosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_empresa_funcionariosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "view_empresa_funcionariosadd.php?" . $this->UrlParm($parm);
		else
			return "view_empresa_funcionariosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("view_empresa_funcionariosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("view_empresa_funcionariosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("view_empresa_funcionariosdelete.php", $this->UrlParm());
	}
