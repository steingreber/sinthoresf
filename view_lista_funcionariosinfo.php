...
$view_lista_funcionarios = NULL;

//
// Table class for view_lista_funcionarios
//
class cview_lista_funcionarios extends cTable {
	var $cod_empresa;
	var $nome_empresa;
	var $nome;
	var $cpf;
	...
	function __construct() {
		...
		$this->TableVar = 'view_lista_funcionarios';
		$this->TableName = 'view_lista_funcionarios';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// cod_empresa
		$this->cod_empresa = new cField('view_lista_funcionarios', 'view_lista_funcionarios', 'x_cod_empresa', 'cod_empresa', '`cod_empresa`', '`cod_empresa`', 3, -1, FALSE, '`cod_empresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cod_empresa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cod_empresa'] = &$this->cod_empresa;

		// nome_empresa
		$this->nome_empresa = new cField('view_lista_funcionarios', 'view_lista_funcionarios', 'x_nome_empresa', 'nome_empresa', '`nome_empresa`', '`nome_empresa`', 200, -1, FALSE, '`nome_empresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nome_empresa'] = &$this->nome_empresa;

		// nome
		$this->nome = new cField('view_lista_funcionarios', 'view_lista_funcionarios', 'x_nome', 'nome', '`nome`', '`nome`', 200, -1, FALSE, '`nome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nome'] = &$this->nome;

		// cpf
		$this->cpf = new cField('view_lista_funcionarios', 'view_lista_funcionarios', 'x_cpf', 'cpf', '`cpf`', '`cpf`', 200, -1, FALSE, '`cpf`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cpf->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cpf'] = &$this->cpf;

		// ativo
		$this->ativo = new cField('view_lista_funcionarios', 'view_lista_funcionarios', 'x_ativo', 'ativo', '`ativo`', '`ativo`', 3, -1, FALSE, '`ativo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`view_lista_funcionarios`";
	}
	...
	// Update Table
	var $UpdateTable = "`view_lista_funcionarios`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_lista_funcionarioslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_lista_funcionariosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_lista_funcionariosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "view_lista_funcionariosadd.php?" . $this->UrlParm($parm);
		else
			return "view_lista_funcionariosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("view_lista_funcionariosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("view_lista_funcionariosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("view_lista_funcionariosdelete.php", $this->UrlParm());
	}
