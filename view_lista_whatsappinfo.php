...
$view_lista_whatsapp = NULL;

//
// Table class for view_lista_whatsapp
//
class cview_lista_whatsapp extends cTable {
	var $nome;
	var $cod_fone_pais;
	var $telefone;
	var $cod_pessoa;
	...
	function __construct() {
		...
		$this->TableVar = 'view_lista_whatsapp';
		$this->TableName = 'view_lista_whatsapp';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// nome
		$this->nome = new cField('view_lista_whatsapp', 'view_lista_whatsapp', 'x_nome', 'nome', '`nome`', '`nome`', 200, -1, FALSE, '`nome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nome'] = &$this->nome;

		// cod_fone_pais
		$this->cod_fone_pais = new cField('view_lista_whatsapp', 'view_lista_whatsapp', 'x_cod_fone_pais', 'cod_fone_pais', '`cod_fone_pais`', '`cod_fone_pais`', 200, -1, FALSE, '`cod_fone_pais`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cod_fone_pais'] = &$this->cod_fone_pais;

		// telefone
		$this->telefone = new cField('view_lista_whatsapp', 'view_lista_whatsapp', 'x_telefone', 'telefone', '`telefone`', '`telefone`', 200, -1, FALSE, '`telefone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->telefone->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['telefone'] = &$this->telefone;

		// cod_pessoa
		$this->cod_pessoa = new cField('view_lista_whatsapp', 'view_lista_whatsapp', 'x_cod_pessoa', 'cod_pessoa', '`cod_pessoa`', '`cod_pessoa`', 3, -1, FALSE, '`cod_pessoa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`view_lista_whatsapp`";
	}
	...
	// Update Table
	var $UpdateTable = "`view_lista_whatsapp`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_lista_whatsapplist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_lista_whatsappview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_lista_whatsappview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "view_lista_whatsappadd.php?" . $this->UrlParm($parm);
		else
			return "view_lista_whatsappadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("view_lista_whatsappedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("view_lista_whatsappadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("view_lista_whatsappdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		// cod_fone_pais
		$this->cod_fone_pais->EditAttrs["class"] = "form-control";
		$this->cod_fone_pais->EditCustomAttributes = "";
		$this->cod_fone_pais->EditValue = ew_HtmlEncode($this->cod_fone_pais->CurrentValue);
		$this->cod_fone_pais->PlaceHolder = ew_RemoveHtml($this->cod_fone_pais->FldCaption());
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->cod_fone_pais->Exportable) $Doc->ExportCaption($this->cod_fone_pais);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->cod_fone_pais->Exportable) $Doc->ExportField($this->cod_fone_pais);
