...
define("EW_PROJECT_NAME", "Sinthoresf2D3", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{31ECB1FF-BE34-4CC5-BF5C-0D3F1718C9D9}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'nIKcYh6Wa2C22xAu', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Sinthoresf2D3.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", '189.90.130.175', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'sinthore_user', TRUE);
define("EW_CONN_PASS", 'kBW3dNhdkpMw', TRUE);
define("EW_CONN_DB", 'sinthore_bdd', TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "admingnove", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "cap4512s", TRUE); // Administrator password
...
// User table filters
define("EW_USER_TABLE", "`permissoes`",  TRUE);
define("EW_USER_NAME_FILTER", "(`a02email` = '%u')",  TRUE);
...
// File upload
define("EW_UPLOAD_DEST_PATH", "sistema/", TRUE); // Upload destination path (relative to app root)
