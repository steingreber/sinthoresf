...
$view_ficha_funcionario = NULL;

//
// Table class for view_ficha_funcionario
//
class cview_ficha_funcionario extends cTable {
	var $socio;
	var $datacadastro;
	var $nome;
	var $endereco;
	...
	function __construct() {
		...
		$this->TableVar = 'view_ficha_funcionario';
		$this->TableName = 'view_ficha_funcionario';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// socio
		$this->socio = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_socio', 'socio', '`socio`', '`socio`', 3, -1, FALSE, '`EV__socio`', TRUE, TRUE, TRUE, 'FORMATTED TEXT');
		$this->socio->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['socio'] = &$this->socio;

		// datacadastro
		$this->datacadastro = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_datacadastro', 'datacadastro', '`datacadastro`', '`datacadastro`', 200, -1, FALSE, '`datacadastro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// nome
		$this->nome = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_nome', 'nome', '`nome`', '`nome`', 200, -1, FALSE, '`nome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nome'] = &$this->nome;

		// endereco
		$this->endereco = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_endereco', 'endereco', '`endereco`', '`endereco`', 200, -1, FALSE, '`endereco`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['endereco'] = &$this->endereco;

		// numero
		$this->numero = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_numero', 'numero', '`numero`', '`numero`', 3, -1, FALSE, '`numero`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->numero->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['numero'] = &$this->numero;

		// complemento
		$this->complemento = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_complemento', 'complemento', '`complemento`', '`complemento`', 200, -1, FALSE, '`complemento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['complemento'] = &$this->complemento;

		// bairro
		$this->bairro = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_bairro', 'bairro', '`bairro`', '`bairro`', 200, -1, FALSE, '`bairro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['bairro'] = &$this->bairro;

		// cidade
		$this->cidade = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_cidade', 'cidade', '`cidade`', '`cidade`', 200, -1, FALSE, '`cidade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cidade'] = &$this->cidade;

		// estado
		$this->estado = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_estado', 'estado', '`estado`', '`estado`', 200, -1, FALSE, '`estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['estado'] = &$this->estado;

		// CEP
		$this->CEP = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_CEP', 'CEP', '`CEP`', '`CEP`', 200, -1, FALSE, '`CEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CEP'] = &$this->CEP;

		// telefone
		$this->telefone = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_telefone', 'telefone', '`telefone`', '`telefone`', 200, -1, FALSE, '`telefone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->telefone->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['telefone'] = &$this->telefone;

		// sexo
		$this->sexo = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_sexo', 'sexo', '`sexo`', '`sexo`', 200, -1, FALSE, '`sexo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['sexo'] = &$this->sexo;

		// datanasc
		$this->datanasc = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_datanasc', 'datanasc', '`datanasc`', '`datanasc`', 200, 7, FALSE, '`datanasc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->datanasc->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['datanasc'] = &$this->datanasc;

		// estado_civil
		$this->estado_civil = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_estado_civil', 'estado_civil', '`estado_civil`', '`estado_civil`', 3, -1, FALSE, '`estado_civil`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->estado_civil->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['estado_civil'] = &$this->estado_civil;

		// rg
		$this->rg = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_rg', 'rg', '`rg`', '`rg`', 200, -1, FALSE, '`rg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['rg'] = &$this->rg;

		// cpf
		$this->cpf = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_cpf', 'cpf', '`cpf`', '`cpf`', 200, -1, FALSE, '`cpf`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cpf->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cpf'] = &$this->cpf;

		// carteira_trabalho
		$this->carteira_trabalho = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_carteira_trabalho', 'carteira_trabalho', '`carteira_trabalho`', '`carteira_trabalho`', 200, -1, FALSE, '`carteira_trabalho`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['carteira_trabalho'] = &$this->carteira_trabalho;

		// nacionalidade
		$this->nacionalidade = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_nacionalidade', 'nacionalidade', '`nacionalidade`', '`nacionalidade`', 200, -1, FALSE, '`nacionalidade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nacionalidade'] = &$this->nacionalidade;

		// naturalidade
		$this->naturalidade = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_naturalidade', 'naturalidade', '`naturalidade`', '`naturalidade`', 200, -1, FALSE, '`naturalidade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['naturalidade'] = &$this->naturalidade;

		// cod_socio
		$this->cod_socio = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_cod_socio', 'cod_socio', '`cod_socio`', '`cod_socio`', 3, -1, FALSE, '`cod_socio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cod_socio->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cod_socio'] = &$this->cod_socio;

		// funcao
		$this->funcao = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_funcao', 'funcao', '`funcao`', '`funcao`', 200, -1, FALSE, '`funcao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['funcao'] = &$this->funcao;

		// dependentes
		$this->dependentes = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_dependentes', 'dependentes', '`dependentes`', '`dependentes`', 201, -1, FALSE, '`dependentes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['dependentes'] = &$this->dependentes;

		// cod_pessoa
		$this->cod_pessoa = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_cod_pessoa', 'cod_pessoa', '`cod_pessoa`', '`cod_pessoa`', 3, -1, FALSE, '`cod_pessoa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cod_pessoa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cod_pessoa'] = &$this->cod_pessoa;

		// A09DESCRICAO
		$this->A09DESCRICAO = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_A09DESCRICAO', 'A09DESCRICAO', '`A09DESCRICAO`', '`A09DESCRICAO`', 201, -1, FALSE, '`A09DESCRICAO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['A09DESCRICAO'] = &$this->A09DESCRICAO;

		// A04imagem
		$this->A04imagem = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_A04imagem', 'A04imagem', '`A04imagem`', '`A04imagem`', 200, -1, FALSE, '`A04imagem`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['A04imagem'] = &$this->A04imagem;

		// A01URL
		$this->A01URL = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_A01URL', 'A01URL', '`A01URL`', '`A01URL`', 200, -1, FALSE, '`A01URL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['A01URL'] = &$this->A01URL;

		// A21EMPRESA
		$this->A21EMPRESA = new cField('view_ficha_funcionario', 'view_ficha_funcionario', 'x_A21EMPRESA', 'A21EMPRESA', '`A21EMPRESA`', '`A21EMPRESA`', 200, -1, FALSE, '`A21EMPRESA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`view_ficha_funcionario`";
	}
	...
	function getSqlSelectList() { // Select for List page
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `nome` FROM `pessoas` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`cod_pessoa` = `view_ficha_funcionario`.`socio` LIMIT 1) AS `EV__socio` FROM `view_ficha_funcionario`" .
			") `EW_TMP_TABLE`";
	...
	// Update Table
	var $UpdateTable = "`view_ficha_funcionario`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_ficha_funcionariolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("view_ficha_funcionarioview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("view_ficha_funcionarioview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "view_ficha_funcionarioadd.php?" . $this->UrlParm($parm);
		else
			return "view_ficha_funcionarioadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("view_ficha_funcionarioedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("view_ficha_funcionarioadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("view_ficha_funcionariodelete.php", $this->UrlParm());
	}
