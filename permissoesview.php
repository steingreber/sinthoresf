...
$permissoes_view = NULL; // Initialize page object first

class cpermissoes_view extends cpermissoes {
	...
	// Page object name
	var $PageObjName = 'permissoes_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "permissoeslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "permissoeslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($permissoes_view)) $permissoes_view = new cpermissoes_view();

// Page init
$permissoes_view->Page_Init();

// Page main
$permissoes_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$permissoes_view->Page_Render();
?>
...
// Page object
var permissoes_view = new ew_Page("permissoes_view");
permissoes_view.PageID = "view"; // Page ID
var EW_PAGE_ID = permissoes_view.PageID; // For backward compatibility

// Form object
var fpermissoesview = new ew_Form("fpermissoesview");

// Form_CustomValidate event
fpermissoesview.Form_CustomValidate = 
...
fpermissoesview.ValidateRequired = true;
<?php } else { ?>
fpermissoesview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $permissoes_view->ExportOptions->Render("body") ?>
<?php
	foreach ($permissoes_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($permissoes->Export == "") { ?>
...
<?php } ?>
<?php $permissoes_view->ShowPageHeader(); ?>
<?php
$permissoes_view->ShowMessage();
?>
<?php if ($permissoes->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($permissoes_view->Pager)) $permissoes_view->Pager = new cPrevNextPager($permissoes_view->StartRec, $permissoes_view->DisplayRecs, $permissoes_view->TotalRecs) ?>
<?php if ($permissoes_view->Pager->RecordCount > 0) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($permissoes_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $permissoes_view->PageUrl() ?>start=<?php echo $permissoes_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($permissoes_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $permissoes_view->PageUrl() ?>start=<?php echo $permissoes_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $permissoes_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($permissoes_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $permissoes_view->PageUrl() ?>start=<?php echo $permissoes_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($permissoes_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $permissoes_view->PageUrl() ?>start=<?php echo $permissoes_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $permissoes_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fpermissoesview" id="fpermissoesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($permissoes_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $permissoes_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="permissoes">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($permissoes->a00id->Visible) { // a00id ?>
	<tr id="r_a00id">
		<td><span id="elh_permissoes_a00id"><?php echo $permissoes->a00id->FldCaption() ?></span></td>
		<td<?php echo $permissoes->a00id->CellAttributes() ?>>
<span id="el_permissoes_a00id">
<span<?php echo $permissoes->a00id->ViewAttributes() ?>>
<?php echo $permissoes->a00id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($permissoes->a01nome->Visible) { // a01nome ?>
	<tr id="r_a01nome">
		<td><span id="elh_permissoes_a01nome"><?php echo $permissoes->a01nome->FldCaption() ?></span></td>
...
<?php echo $permissoes->a01nome->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($permissoes->a02email->Visible) { // a02email ?>
	<tr id="r_a02email">
		<td><span id="elh_permissoes_a02email"><?php echo $permissoes->a02email->FldCaption() ?></span></td>
...
<?php echo $permissoes->a02email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($permissoes->a03senha->Visible) { // a03senha ?>
	<tr id="r_a03senha">
		<td><span id="elh_permissoes_a03senha"><?php echo $permissoes->a03senha->FldCaption() ?></span></td>
...
<?php echo $permissoes->a03senha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fpermissoesview.Init();
</script>
<?php
$permissoes_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($permissoes->Export == "") { ?>
...
<?php
$permissoes_view->Page_Terminate();
?>
