...
class crel_empresas_regioes_ extends cTableBase {
	...
	function __construct() {
		...
		// regiao1
		$this->regiao1 = new cField('rel_empresas_regioes_', 'rel_empresas_regioes_', 'x_regiao1', 'regiao1', '`regiao1`', '`regiao1`', 200, -1, FALSE, '`regiao1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['regiao1'] = &$this->regiao1;

		// Count(funcionarios.cod_func)
		$this->Count28funcionarios_cod_func29 = new cField('rel_empresas_regioes_', 'rel_empresas_regioes_', 'x_Count28funcionarios_cod_func29', 'Count(funcionarios.cod_func)', '`Count(funcionarios.cod_func)`', '`Count(funcionarios.cod_func)`', 20, -1, FALSE, '`Count(funcionarios.cod_func)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
...
?>
	<tr>
		...
		<td class="ewGroupHeader"><?php echo $rel_empresas_regioes_->regiao1->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $rel_empresas_regioes_->Count28funcionarios_cod_func29->FldCaption() ?></td>
	</tr>
<?php
	}
	while (!$rel_empresas_regioes__report->DetailRecordset->EOF) {
		...
		$rel_empresas_regioes_->regiao1->setDbValue($rel_empresas_regioes__report->DetailRecordset->fields('regiao1'));
		$rel_empresas_regioes_->Count28funcionarios_cod_func29->setDbValue($rel_empresas_regioes__report->DetailRecordset->fields('Count(funcionarios.cod_func)'));
...
<?php echo $rel_empresas_regioes_->endereco->ViewValue ?>, <?php echo $rel_empresas_regioes_->numero->ViewValue ?></span>
</td>
...
<?php echo $rel_empresas_regioes_->telefone->ViewValue ?></span>
		...
		<td<?php echo $rel_empresas_regioes_->regiao1->CellAttributes() ?>>
<span<?php echo $rel_empresas_regioes_->regiao1->ViewAttributes() ?>>
<?php echo $rel_empresas_regioes_->regiao1->ViewValue ?></span>
</td>
		<td  align="center"<?php echo $rel_empresas_regioes_->Count28funcionarios_cod_func29->CellAttributes() ?>>
<span<?php echo $rel_empresas_regioes_->Count28funcionarios_cod_func29->ViewAttributes() ?>>
<?php echo $rel_empresas_regioes_->Count28funcionarios_cod_func29->ViewValue ?></span>
</td>
	</tr>
<?php
...
<?php if ($rel_empresas_regioes__report->RecordExists) { ?>
	...
	<tr><td colspan=10 class="ewGrandSummary"><?php echo $Language->Phrase("RptGrandTotal") ?>&nbsp;(<?php echo ew_FormatNumber($rel_empresas_regioes__report->ReportCounts[0], 0) ?>&nbsp;<?php echo $Language->Phrase("RptDtlRec") ?>)</td></tr>
<?php } ?>
<?php if ($rel_empresas_regioes__report->RecordExists) { ?>
	<tr><td colspan=10>&nbsp;<br></td></tr>
<?php } else { ?>
