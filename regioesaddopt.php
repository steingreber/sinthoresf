...
$regioes_addopt = NULL; // Initialize page object first

class cregioes_addopt extends cregioes {
	...
	// Page object name
	var $PageObjName = 'regioes_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					$row = array();
					$row["x_id_regiao"] = $this->id_regiao->DbValue;
					$row["x_regiao"] = $this->regiao->DbValue;
					if (!EW_DEBUG_ENABLED && ob_get_length())
						ob_end_clean();
	...
	function LoadFormValues() {
		...
		if (!$this->regiao->FldIsDetailKey) {
			$this->regiao->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_regiao")));
		}
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->regiao->CurrentValue = ew_ConvertToUtf8($this->regiao->FormValue);
	}
...
// Create page object
if (!isset($regioes_addopt)) $regioes_addopt = new cregioes_addopt();

// Page init
$regioes_addopt->Page_Init();

// Page main
$regioes_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$regioes_addopt->Page_Render();
?>
<script type="text/javascript">

// Page object
var regioes_addopt = new ew_Page("regioes_addopt");
regioes_addopt.PageID = "addopt"; // Page ID
var EW_PAGE_ID = regioes_addopt.PageID; // For backward compatibility

// Form object
var fregioesaddopt = new ew_Form("fregioesaddopt");

// Validate form
fregioesaddopt.Validate = function() {
...
fregioesaddopt.Form_CustomValidate = 
...
fregioesaddopt.ValidateRequired = true;
<?php } else { ?>
fregioesaddopt.ValidateRequired = false; 
<?php } ?>
...
<?php
$regioes_addopt->ShowMessage();
?>
<form name="fregioesaddopt" id="fregioesaddopt" class="ewForm form-horizontal" action="regioesaddopt.php" method="post">
<?php if ($regioes_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $regioes_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="regioes">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_regiao"><?php echo $regioes->regiao->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-9">
