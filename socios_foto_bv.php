...
$socios_foto_blobview = NULL; // Initialize page object first

class csocios_foto_blobview extends csocios {
	...
	// Page object name
	var $PageObjName = 'socios_foto_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'socios');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('socios', 'x_foto');
...
// Create page object
if (!isset($socios_foto_blobview)) $socios_foto_blobview = new csocios_foto_blobview();

// Page init
$socios_foto_blobview->Page_Init();

// Page main
$socios_foto_blobview->Page_Main();
?>
<?php
$socios_foto_blobview->Page_Terminate();
?>
