...
$rel_socios_recibo_empresa__A04imagem_blobview = NULL; // Initialize page object first

class crel_socios_recibo_empresa__A04imagem_blobview extends crel_socios_recibo_empresa_ {
	...
	// Page object name
	var $PageObjName = 'rel_socios_recibo_empresa__A04imagem_blobview';
...
// Create page object
if (!isset($rel_socios_recibo_empresa__A04imagem_blobview)) $rel_socios_recibo_empresa__A04imagem_blobview = new crel_socios_recibo_empresa__A04imagem_blobview();

// Page init
$rel_socios_recibo_empresa__A04imagem_blobview->Page_Init();

// Page main
$rel_socios_recibo_empresa__A04imagem_blobview->Page_Main();
?>
<?php
$rel_socios_recibo_empresa__A04imagem_blobview->Page_Terminate();
?>
