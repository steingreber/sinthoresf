...
$rel_carteira_clube__foto_blobview = NULL; // Initialize page object first

class crel_carteira_clube__foto_blobview extends crel_carteira_clube_ {
	...
	// Page object name
	var $PageObjName = 'rel_carteira_clube__foto_blobview';
...
// Create page object
if (!isset($rel_carteira_clube__foto_blobview)) $rel_carteira_clube__foto_blobview = new crel_carteira_clube__foto_blobview();

// Page init
$rel_carteira_clube__foto_blobview->Page_Init();

// Page main
$rel_carteira_clube__foto_blobview->Page_Main();
?>
<?php
$rel_carteira_clube__foto_blobview->Page_Terminate();
?>
