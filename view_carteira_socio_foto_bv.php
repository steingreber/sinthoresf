...
$view_carteira_socio_foto_blobview = NULL; // Initialize page object first

class cview_carteira_socio_foto_blobview extends cview_carteira_socio {
	...
	// Page object name
	var $PageObjName = 'view_carteira_socio_foto_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'view_carteira_socio');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('view_carteira_socio', 'x_foto');
		...
		// SQL constructor in view_carteira_socio class, view_carteira_socioinfo.php
...
// Create page object
if (!isset($view_carteira_socio_foto_blobview)) $view_carteira_socio_foto_blobview = new cview_carteira_socio_foto_blobview();

// Page init
$view_carteira_socio_foto_blobview->Page_Init();

// Page main
$view_carteira_socio_foto_blobview->Page_Main();
?>
<?php
$view_carteira_socio_foto_blobview->Page_Terminate();
?>
